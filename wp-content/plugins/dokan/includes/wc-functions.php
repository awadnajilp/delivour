        ...
        <?php if ( ! $variation_attribute_found ) : ?>
            ...
            <div id="message" class="inline woocommerce-message">
                <div class="squeezer">
                    ...
                    <p class="submit"><a class="button-primary" href="http://anonym.to/http://docs.woothemes.com/document/product-variations/" target="_blank"><?php _e( 'Learn more', 'woocommerce' ); ?></a></p>
                </div>
            </div>
