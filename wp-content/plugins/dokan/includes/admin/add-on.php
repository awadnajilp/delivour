        ...
        foreach ($add_ons as $addon) {
            ...
            <div class="wpuf-addon">
                <div class="wpuf-addon-thumb">
                    <a href="<?php echo 'http://blankrefer.com/?'.$addon->url; ?>" target="_blank">
                ...
                <div class="wpuf-detail">
                    <h3 class="title">
                        <a href="<?php echo 'http://blankrefer.com/?'.$addon->url; ?>" target="_blank"><?php echo $addon->title; ?></a>
                    </h3>
                ...
                <div class="wpuf-links">
                    <?php if ( class_exists( $addon->class ) ) { ?>
                        <a class="button button-disabled" href="<?php echo 'http://blankrefer.com/?'.$addon->url; ?>" target="_blank">Installed</a>
                    <?php } else { ?>
                        <a class="button" href="<?php echo 'http://blankrefer.com/?'.$addon->url; ?>" target="_blank">View Details</a>
                    <?php } ?>
                </div>
            </div>
