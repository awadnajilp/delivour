...
jQuery(document).ready(function($){
		...
		utils : {
			miscellaneous : function(){
				...
				$('#portfolio-gallery .portfolio-items, .widget_templatation_testimonials .testimonials-list').wrapInner('<div class="inner"></div>'); 
				...
				$('.wpb_row .home-featured ul.products .innerfet').removeClass('innerfet').addClass('innerfetvc'); 
				
				if ($('#main.col-left .home-featured ul.products > .innerfetvc').length ) {
				$('.home-featured ul.products > .innerfetvc').bxSlider({ pager: false, controls: true, useCSS: false, minSlides: 1, maxSlides: 3, moveSlides: 1, slideWidth: 198, slideMargin: 11 });
				}
				else {
				$('.home-featured ul.products > .innerfetvc').bxSlider({ pager: false, controls: true, useCSS: false, minSlides: 1, maxSlides: 4, moveSlides: 1, slideWidth: 218, slideMargin: 11 });
				}
				...
				$('.home-featured ul.products > .innerfet').each(function(){ $(this).bxSlider({ pager: false, controls: true, useCSS: false, minSlides: 1, maxSlides: 4, moveSlides: 1, slideWidth: 228, slideMargin: 11 }); }); //wc
