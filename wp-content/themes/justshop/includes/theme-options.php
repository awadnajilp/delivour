...
// changed below to remove php Notice array to string conversion 
...
$options[] = array( 'name' => __( 'Enable Widescreen Mode ?', 'templatation' ),
    				'desc' => __( 'If you check this , the main container with white background will flow to full availble width horizontally(by default its 950px fixed width). Note that content will still be inside 950px width, only background will be full width. If you are not sure, try it :).', 'templatation' ),
...
$options[] = array( 'name' => __( 'Tracking Code', 'templatation' ),
    				'desc' => __( 'Paste your Google Analytics (or other) tracking code here. This will be added into the footer template of your theme.', 'templatation' ),
...
$options[] = array( 'name' => __( 'Background', 'templatation' ),
    				'type' => 'subheading' );
...
$options[] = array( 'name' => __( 'Body background image', 'templatation' ),
...
$options[] = array( 'name' => __( 'Teaser Text Icon', 'templatation' ),
                    'desc' => __( 'Teaser text is short sentence that you want to highlight. eg : Our helpline number : xyz. This icon appears on left side of it. Recommended size : 21 x 21 px.', 'templatation' ),
...
$options[] = array( 'name' => __( 'Your Twitter username', 'templatation' ),
					'desc' => __( 'Enter your Twitter username. Example: templatation', 'templatation' ),
