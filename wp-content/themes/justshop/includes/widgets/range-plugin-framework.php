	...
	abstract class RangePlugin {
		...
		public function register_options_page() {
			if ( apply_filters( 'rpf-options_page-'.$this->_slug, true ) && is_callable( array( $this, 'options_page' ) ) )
				add_submenu_page( 'templatation', $this->_pageTitle, $this->_menuTitle, $this->_accessLevel, $this->_hook, array( $this, 'options_page' ) );
		}
		...
		public function get_options_url() {
			return admin_url( 'admin.php?page=' . $this->_hook );
		}
