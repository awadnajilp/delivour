...
$output .= "\n\t".'<div class="'.$element.' templatation '.$css_class.'" data-interval="'.$interval.'">';
$output .= "\n\t\t".'<div class="wpb_wrapper wpb_tour_tabs_wrapper ui-tabs clearfix">';
$output .= wpb_widget_title(array('title' => $title, 'extraclass' => $element.'_heading'));
$output .= "\n\t\t\t".$tabs_nav;
$output .= "\n\t\t\t".wpb_js_remove_wpautop($content);
/*if ( 'vc_tour' == $this->shortcode) {
    $output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="'.__('Previous slide', 'templatation').'">'.__('Previous slide', 'templatation').'</a></span> <span class="wpb_next_slide"><a href="#next" title="'.__('Next slide', 'templatation').'">'.__('Next slide', 'templatation').'</a></span></div>';
}
