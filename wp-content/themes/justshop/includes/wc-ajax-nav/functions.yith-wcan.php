...
function yith_wcan_attributes_table( $type, $attribute, $id, $name, $values = array(), $echo = true ) {
    ...
    if( 'list' == $type ) {
        ...
        if( !empty($terms) ) {
            $return = sprintf('<table><tr><th>%s</th><th>%s</th></tr>', __('Term', 'templatation'), __('Color', 'templatation'));
        ...
        if( !empty($terms) ) {
            $return = sprintf('<table><tr><th>%s</th><th>%s</th></tr>', __('Term', 'templatation'), __('Labels', 'templatation'));
