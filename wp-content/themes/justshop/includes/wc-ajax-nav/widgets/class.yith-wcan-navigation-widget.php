...
if( !class_exists( 'YITH_WCAN' ) ) {
    ...
    class YITH_WCAN_Navigation_Widget extends WP_Widget {
        ...
        function __construct() {
            $widget_ops = array('classname' => 'yith-woo-ajax-navigation woocommerce widget_layered_nav', 'description' => __( 'Narrow down the products list without reloading the page', 'templatation') );
            $control_ops = array('width' => 400, 'height' => 350);
            parent::__construct('yith-woo-ajax-navigation', __('JS WooCommerce Ajax Navigation', 'templatation'), $widget_ops, $control_ops);
        }
        ...
        function widget( $args, $instance ) {
            ...
            if ( count( $terms ) > 0 ) {
                ...
                <a class="yit-wcan-select-open" href="#"><?php _e('Filters List:', 'templatation') ?></a>
                ...
                echo "</div>";
                    ...
                    foreach ( $terms as $term ) {
                        ...
                        echo ( $count > 0 || $option_is_set ) ? '<div class="shade-c"></div></a>' : '<div class="shade-c"></div></span>';
        ...
        function form( $instance ) {
            ...
            <p>
                <label>
                    <strong><?php _e( 'Title', 'templatation' ) ?>:</strong><br />
                    <input class="widefat" type="text" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
                </label>
            </p>

            <p><label for="<?php echo $this->get_field_id('attribute'); ?>"><strong><?php _e('Attribute:', 'templatation') ?></strong></label>
            ...
            <p><label for="<?php echo $this->get_field_id( 'query_type' ); ?>"><?php _e( 'Query Type:', 'templatation' ) ?></label>
                <select id="<?php echo esc_attr( $this->get_field_id( 'query_type' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'query_type' ) ); ?>">
                    <option value="and" <?php selected( $instance['query_type'], 'and' ); ?>><?php _e( 'AND', 'templatation' ); ?></option>
                    <option value="or" <?php selected( $instance['query_type'], 'or' ); ?>><?php _e( 'OR', 'templatation' ); ?></option>
                </select></p>

            <p><label for="<?php echo $this->get_field_id('type'); ?>"><strong><?php _e('Type:', 'templatation') ?></strong></label>
                <select class="yith_wcan_type widefat" id="<?php echo esc_attr( $this->get_field_id('type') ); ?>" name="<?php echo esc_attr( $this->get_field_name('type') ); ?>">
                    <option value="list" <?php selected( 'list', $instance['type'] ) ?>><?php _e( 'List', 'templatation' ) ?></option>
                    <option value="color" <?php selected( 'color', $instance['type'] ) ?>><?php _e( 'Color', 'templatation' ) ?></option>
                    <option value="label" <?php selected( 'label', $instance['type'] ) ?>><?php _e( 'Label', 'templatation' ) ?></option>
                    <option value="select" <?php selected( 'select', $instance['type'] ) ?>><?php _e( 'Dropdown', 'templatation' ) ?></option>
                </select></p>
