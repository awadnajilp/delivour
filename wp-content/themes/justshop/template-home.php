...
?>
    ...
    <div id="content" class="page col-full">
    	...
    	<div class="module-b" style="margin-bottom:0px">
    		<div class="cols-bs">
    			<?php
        	if ( have_posts() ) { $count = 0;
        		while ( have_posts() ) { the_post(); $count++;
        		
        		 the_content(); // content area include location choose form as shortcode
									   } // End WHILE Loop
								}
											?>
    		</div>
    	...
    	<?php woo_main_before();	//city_choose_form(); ?>
